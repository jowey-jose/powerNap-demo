    ...
    <section class="home-slider owl-carousel">
        ...
        <div class="container">
          ...
          <div class="col-md-12 ftco-animate text-center">
          	<div class="text mb-5 pb-3">
	            <h1 class="mb-3">Welcome To Power Nap</h1>
      ...
      <div class="slider-item" style="background-image:url(images/bg_2.jpg);">
        ...
        <div class="container">
          ...
          <div class="col-md-12 ftco-animate text-center">
          	<div class="text mb-5 pb-3">
	            <h1 class="mb-3">Enjoy A Refreshing Rest</h1>
	            <h2>Join With Us</h2>
            </div>
          </div>
        </div>
	        			...
	        			<div class="col-md d-flex">
	        				<div class="form-group p-4 align-self-stretch d-flex align-items-end">
			                    ...
			                    <select name="" id="" class="form-control">
			                      ...
			                      <option value="">Town CBD</option>
			                      <option value="">Upperhill</option>
			                      <option value="">Waiyaki Road</option>
			                      <option value="">Mombasa Road</option>
			                      <option value="">Thika Road</option>
			                    </select>
			                  </div>
				              </div>
				            </div>
			...
			<div class="container">
	          ...
	          <div class="heading-section heading-section-wo-line pt-md-5 pl-md-5 mb-5">
	          	<div class="ml-md-0">
		            ...
		            <h2 class="mb-4">What are our rates?</h2>
	            </div>
	          </div>
	          <div class="pb-md-5">
							<p>We charge our clients on a time basis depending on how much time they wish to spend in our cacoons. The rates also vary from one location to another. Currently, our highest rates are at the Intercontinental Hotel where we offer a 30-minute power nap at sh1500 during regular hours. Peak hours ( between 12-2pm) rate at sh 2500 per half hour. Clients can stay for as long as they like. We operate a 24/7 system which allows night workers to fit into our system. All payments are made online.</p>
